...
int Lab4() {
  ...
  // TH2 (const char *name, const char *title, Int_t nbinsx, Double_t xlow,
  ...
  cout << "Expected Value H1: \n E(x): " << h1->GetMean(1)
       << " E(y): " << h1->GetMean(2) << endl;
  cout << "Expected Value H2: \n E(x): " << h2->GetMean(1)
       << " E(y): " << h2->GetMean(2) << endl;
  cout << "Expected Value H3: \n E(x): " << h3->GetMean(1)
       << " E(y): " << h3->GetMean(2) << endl;

  cout << endl;
  cout << endl;

  cout << "Standard Deviation H1: \n sigma(x): " << h1->GetRMS(1)
       << " sigma(y): " << h1->GetRMS(2) << endl;
  cout << "Standard Deviation H2: \n sigma(x): " << h2->GetRMS(1)
       << " sigma(y): " << h2->GetRMS(2) << endl;
  cout << "Standard Deviation H3: \n sigma(x): " << h3->GetRMS(1)
       << " sigma(y): " << h3->GetRMS(2) << endl;
  ...
  cout << "Correlation Factor H1: \n ro(x, y): " << h1->GetCorrelationFactor()
       << endl;
  cout << "Correlation Factor H2: \n ro(x, y): " << h2->GetCorrelationFactor()
       << endl;
  cout << "Correlation Factor H3: \n ro(x, y): " << h3->GetCorrelationFactor()
       << endl;
