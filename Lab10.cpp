...
int Lab10(){
	...
	cout << "Chi2/ndf: " <<h1->GetFunction("f1")->GetChisquare()/ h1->GetFunction("f1")->GetNDF() << endl;

	cout << "Kwantyl ChiSquare: 16.81" << endl;
	cout << "Warunek 10.31 > 16.81 nie jest spełniony, zatem na poziomie istotności 1% nie ma podstaw do odrzucenia hipotezy" << endl;
